...
<head>
    ...
    <title>Smitha's Academy | Courses - IELTS, OET, GERMAN, NCLEX-RN, HAAD, DHA, MOH, CBT, FRENCH, MDS courses at Smitha's Academy, Pampady, Kottayam.</title>
...
<div class="top-bar py-2">
    <div class="container d-flex justify-content-between align-items-center">
        <div class="contact-info">
            <a href="tel:+919188168989" class="text-white text-decoration-none me-3"><i class="fas fa-phone-alt me-1"></i> +91 9188168989</a>
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-lg-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu shadow">
                        <li><a class="dropdown-item" href="#ielts"><i class="fas fa-globe-me-2 text-primary"></i> IELTS <span class="badge bg-primary ms-2 text-white">Top!</span></a></li>
                        <li><a class="dropdown-item" href="#oet"><i class="fas fa-stethoscope me-2 text-danger"></i> OET <span class="badge bg-danger ms-2 text-white">Popular</span></a></li>
                        <li><a class="dropdown-item" href="#german"><i class="fas fa-language me-2 text-warning"></i> GERMAN <span class="badge bg-warning ms-2 text-white">Hot</span></a></li>
                        <li><a class="dropdown-item" href="#nclex"><i class="fas fa-user-nurse me-2 text-info"></i> NCLEX-RN</a></li>
                        <li><a class="dropdown-item" href="#prometric"><i class="fas fa-heartbeat me-2 text-success"></i> PROMETRIC/DHA/HAAD/MOH</a></li>
                        <li><a class="dropdown-item" href="#cbt-french-mds"><i class="fas fa-book-medical me-2 text-primary"></i> CBT/FRENCH/MDS</a></li>
                    </ul>
                </li>
                <li class="nav-item"><a class="nav-link" href="success-stories.jsp">Success Stories</a></li>
    ...
    <div class="container">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="index.jsp" class="text-white text-decoration-none">Home</a></li>
    ...
    <div class="container">
        <div class="row align-items-center g-5">
            <div class="col-lg-6 order-2 order-lg-1" data-aos="fade-right">
                <span class="course-detail-badge badge bg-primary bg-opacity-10 text-primary mb-3">IELTS - International English Language Testing System</span>
                <h2 class="section-title mb-4">Master the IELTS with Us</h2>
                <p class="lead mb-4 text-secondary">IELTS is the world's most popular English language proficiency test for higher education and global migration.</p>
                <p class="mb-4">We offer professional training for both <strong>Academic</strong> (for students) and <strong>General Training</strong> (for migration) modules.</p>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless mb-0">
                            <tbody>
                                ...
                                <tr>
                                    <td><i class="fas fa-calendar-alt text-primary me-2"></i> <strong>Schedule:</strong></td>
                                    <td>Morning / Evening / Weekend / Online</td>
                                </tr>
                                <tr>
                                    <td><i class="fas fa-chalkboard-teacher text-primary me-2"></i> <strong>Mock Tests:</strong></td>
                ...
                <div class="row g-4">
                    <div class="col-md-6 col-6">
                        <div class="syllabus-card" data-aos="zoom-in" data-aos-delay="100">
                            ...
                            <ul class="list-unstyled">
                                <li><i class="bi bi-check2-circle text-primary me-1"></i>Note completion techniques</li>
                                <li><i class="bi bi-check2-circle text-primary me-1"></i>Multiple choice strategies</li>
                                <li><i class="bi bi-check2-circle text-primary me-1"></i>Map & diagram labelling</li>
                                <li><i class="bi bi-check2-circle text-primary me-1"></i>Sections 1-4 mastery</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-6 col-6">
                        <div class="syllabus-card" data-aos="zoom-in" data-aos-delay="200">
                            ...
                            <ul class="list-unstyled">
                                <li><i class="bi bi-check2-circle text-primary me-1"></i>Skimming & scanning</li>
                                <li><i class="bi bi-check2-circle text-primary me-1"></i>True/False/Not Given tips</li>
                                <li><i class="bi bi-check2-circle text-primary me-1"></i>Summary completion</li>
                                <li><i class="bi bi-check2-circle text-primary me-1"></i>Time management tips</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-6 col-6">
                        <div class="syllabus-card" data-aos="zoom-in" data-aos-delay="300">
                            ...
                            <ul class="list-unstyled">
                                <li><i class="bi bi-check2-circle text-primary me-1"></i>Task 1: Graph / Charts</li>
                                <li><i class="bi bi-check2-circle text-primary me-1"></i>Task 2: Essay writing</li>
                                <li><i class="bi bi-check2-circle text-primary me-1"></i>Cohesion & coherence</li>
                    ...
                    <div class="col-md-6 col-6">
                        <div class="syllabus-card" data-aos="zoom-in" data-aos-delay="400">
                            ...
                            <ul class="list-unstyled">
                                <li><i class="bi bi-check2-circle text-primary me-1"></i>Part 1, 2 & 3 techniques</li>
                                <li><i class="bi bi-check2-circle text-primary me-1"></i>Fluency & pronunciation</li>
                                <li><i class="bi bi-check2-circle text-primary me-1"></i>One-on-one mock interviews</li>
                                <li><i class="bi bi-check2-circle text-primary me-1"></i>Recorded feedback sessions</li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row align-items-center g-5">
            <div class="col-lg-6" data-aos="fade-right">
                <span class="course-detail-badge badge bg-danger bg-opacity-10 text-danger mb-3">OET - Occupational English Test</span>
                <h2 class="section-title mb-4">Dedicated OET Coaching for Healthcare Professionals</h2>
                <p class="lead mb-4 text-secondary">OET is a healthcare-specific English language test accepted by medical councils, nursing boards, and hospitals in the UK, Ireland, Australia, and more. Smitha's Academy provides specialized OET coaching for nurses, doctors, pharmacists, and other healthcare workers.</p>
                <div class="row g-2 mb-4">
                    <div class="col-6 col-md-4"><span class="profession-tag"><i class="fas fa-user-nurse me-1"></i> Nurses</span></div>
                    <div class="col-6 col-md-4"><span class="profession-tag"><i class="fas fa-user-md me-1"></i> Doctors</span></div>
                    <div class="col-6 col-md-4"><span class="profession-tag"><i class="fas fa-pills me-1"></i> Pharmacists</span></div>
                    <div class="col-6 col-md-4"><span class="profession-tag"><i class="fas fa-tooth me-1"></i> Dentists</span></div>
                    <div class="col-6 col-md-4"><span class="profession-tag"><i class="fas fa-heartbeat me-1"></i> Physiotherapists</span></div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless mb-0">
                            <tbody>
                                ...
                                <tr>
                                    <td><i class="fas fa-calendar-alt text-danger me-2"></i> <strong>Schedule:</strong></td>
                                    <td>Morning / Evening / Weekend / Online</td>
                                </tr>
                                <tr>
                                    <td><i class="fas fa-chalkboard-teacher text-danger me-2"></i> <strong>Mock Tests:</strong></td>
...
<section id="german" class="section-padding bg-light">
    <div class="container">
        <div class="row align-items-center g-5">
            <div class="col-lg-6 order-2 order-lg-1" data-aos="fade-right">
                <span class="course-detail-badge badge bg-warning bg-opacity-10 text-dark mb-3">German Language Learning</span>
                <h2 class="section-title mb-4">Master German for Future Opportunities</h2>
                <p class="lead mb-4 text-secondary">German is the language of opportunities - for students studying in Germany, professionals seeking jobs, or anyone planning to settle in German-speaking countries. We offer Goethe-aligned training from A1 to B2 levels with expert certified trainers.</p>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless mb-0">
                            <tbody>
                                ...
                                <tr>
                                    <td><i class="fas fa-calendar-alt text-warning me-2"></i> <strong>Schedule:</strong></td>
                                    <td>Morning / Weekend / Online</td>
                                </tr>
                                <tr>
                                    <td><i class="fas fa-chalkboard-teacher text-warning me-2"></i> <strong>Trainers:</strong></td>
    ...
    <div class="container">
        <div class="row align-items-center g-5">
            <div class="col-lg-6" data-aos="fade-right">
                ...
                <p class="lead mb-4 text-secondary">NCLEX-RN is the globally recognized nursing board exam required to practice as a Registered Nurse in the USA, Canada and Australia. Smitha's Academy offers a comprehensive coaching program.</p>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless mb-0">
                            <tbody>
                                ...
                                <tr>
                                    <td><i class="fas fa-chalkboard-teacher text-info me-2"></i> <strong>Materials:</strong></td>
...
<section id="prometric" class="section-padding bg-light">
    <div class="container">
        <div class="row align-items-center g-5">
            <div class="col-lg-6 order-2 order-lg-1" data-aos="fade-right">
                <span class="course-detail-badge badge bg-success bg-opacity-10 text-success mb-3">PROMETRIC / DHA / HAAD / MOH</span>
                <h2 class="section-title mb-4">Start Your Healthcare Career in the Middle East</h2>
                <p class="lead mb-4 text-secondary">These exams are required for healthcare professionals working in Gulf countries.</p>
                <p>We provide focused coaching for DHA (Dubai), HAAD (Abu Dhabi), MOH (UAE), OMSB (Oman), SCFHS (Saudi Arabia) and more.</p>
                <div class="row g-2 mb-4">
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless mb-0">
                            <tbody>
                                ...
                                <tr>
                                    <td><i class="fas fa-check-circle text-success me-2"></i> <strong>Mock Exams:</strong></td>
                                    <td>Daily Practice MCQ sets</td>
                                </tr>
                                <tr>
                                    <td><i class="fas fa-file-invoice text-success me-2"></i> <strong>Dataflow:</strong></td>
                ...
                <div class="text-center mt-3">
                    <a href="register.jsp?course=PROMETRIC" class="btn text-white btn-lg px-5 shadow" style="background-color: #208e4c;">
                        <i class="fas fa-user-plus me-2"></i> Enroll Now
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left">
                <div class="syllabus-card shadow-sm" style="background-color: #f8f9fa; border-left: 5px solid #208e4c;">
                    <h5 class="mb-3 text-success">Professionals We Support:</h5>
                    <ul class="list-group list-group-flush bg-transparent">
                        <li class="list-group-item bg-transparent"><i class="fas fa-user-nurse text-success me-2"></i> Nurses (RN/PN)</li>
                        <li class="list-group-item bg-transparent"><i class="fas fa-user-md text-success me-2"></i> Doctors (GP/Specialist)</li>
                        <li class="list-group-item bg-transparent"><i class="fas fa-pills text-success me-2"></i> Pharmacists</li>
                        <li class="list-group-item bg-transparent"><i class="fas fa-vial text-success me-2"></i> Lab Technicians</li>
                        <li class="list-group-item bg-transparent"><i class="fas fa-tooth text-success me-2"></i> Dentists</li>
                        <li class="list-group-item bg-transparent"><i class="fas fa-microscope text-success me-2"></i> Physiotherapists</li>
                        <li class="list-group-item bg-transparent"><i class="fas fa-notes-medical text-success me-2"></i> Radiographers</li>
                    </ul>
                    <div class="mt-3 p-3 bg-white rounded border">
                        <h6 class="fw-bold mb-2"><i class="fas fa-laptop-code me-2"></i> MCQ Question Bank:</h6>
                        <p class="small mb-0">Get access to 5000+ latest MCQs and previous year questions updated for 2024 exams.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4">
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                <div class="syllabus-card h-100" style="background: #fdf2f2; border-top: 5px solid #dc3545;">
                    ...
                    <p class="text-secondary">Computer Based Test for Nurses seeking UK Registration. Focus on Clinical, Professional, and Patient Safety domains.</p>
            ...
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                <div class="syllabus-card h-100" style="background: #f2f7fd; border-top: 5px solid #0d6efd;">
                    ...
                    <p class="text-secondary">Learn French for Canada Migration (TEF/TCF) or personal interest. Certified training for A1, A2 & B1 levels.</p>
                    <ul class="list-unstyled mb-4">
                    ...
                    <a href="register.jsp?course=FRENCH" class="btn btn-outline-primary w-100 mt-auto">Enroll Now</a>
                </div>
            </div>
            ...
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
                <div class="syllabus-card h-100" style="background: #f2fdf5; border-top: 5px solid #198754;">
                    ...
                    <p class="text-secondary">Entrance coaching for Dental Graduates seeking Master of Dental Surgery. Subject-wise expert guidance.</p>
                    <ul class="list-unstyled mb-4">
                    ...
                    <a href="register.jsp?course=MDS" class="btn btn-outline-success w-100 mt-auto">Enroll Now</a>
                </div>
            </div>
        </div>
    </div>
...
<section class="cta-section section-padding text-white text-center">
    <div class="container">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-center gap-3">
            ...
            <a href="tel:+919188168989" class="btn btn-outline-light btn-lg px-5 py-3">
...
<a href="https://wa.me/919188168989" class="whatsapp-float" target="_blank">
